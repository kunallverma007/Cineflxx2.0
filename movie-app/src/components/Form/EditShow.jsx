...
function EditShow(props){
    ...
    async function submit(){
        ...
        const data={_id:user,movie_id:movie_id,slot:time,prices:[silver,gold,platinum],language,to,from,theater_name:props.location.en.username,movie_title:props.location.en.title};
        try{
            await axios.post('/edit_show',data) 
            alert("Movie is updated successfully redirecting in 6 secs")
