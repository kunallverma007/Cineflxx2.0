...
export default function Home() {
  ...
  async function auth() {
    ...
    if (auth !== false) {
      ...
      if (type === "user") {
        ...
        try {
          console.log("Hello");
          x = await axios.post("/theater", { _id: user });
  ...
  return (
    <div style={{ width: "100%", height: "100% ", backgroundColor: "black" }}>
      <CustomNavbar _id={_id} name={name} />
      <Mainbg />
      <Horizontaldiv></Horizontaldiv>
      <h2 style={{ marginLeft: "5%", color: "white" }} id="trending">
        Trending
      </h2>
      <div
        style={{
          marginLeft: "5%",
          marginRight: "4%",
          background: `url("https://www.themoviedb.org/assets/2/v4/misc/trending-bg-39afc2a5f77e31d469b25c187814c0a2efef225494c038098d62317d923f8415.svg")`,
