  ...
  return (
    <div>
      ...
      a 15.9155 15.9155 0 0 1 0 -31.831"
                ...
                <div>
                  ...
                  >
                    {type === "user" ? (
                      ...
                      <button type="submit" onClick={showTheater}>
                        Show Now
                      </button>
                    )}
                  </div>
                ...
                <h3>Overview</h3>
                <p
                  style={{ color: "white", fontSize: "19px", maxWidth: "80%" }}
                >
                  {movieData.overview}
                </p>
              </div>
              <div className="movieprofile">
                <img
                  src={`https://www.themoviedb.org/t/p/w300_and_h450_face${movieData.poster_path}`}
